<div class="relative py-16">
  ...
  <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6" id="cta">
    <div class="relative">
      ...
      <div class="mt-6 m-auto space-y-6 md:w-8/12 lg:w-7/12">
        ...
        <div class="flex flex-wrap justify-center gap-6">
          <a
            href="#"
            class="relative flex h-12 w-full items-center justify-center px-8 before:absolute before:inset-0 before:rounded before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max"
          >
            <span
